...
const IMPATIENT_CONFIRM_TIMEOUT = __ENV.IMPATIENT_CONFIRM_TIMEOUT || '2s';
...
const STAGE_2_TARGET = Number(__ENV.K6_STAGE_2_TARGET || '20');
const STAGE_3_DURATION = __ENV.K6_STAGE_3_DURATION || '3m';
const STAGE_3_TARGET = Number(__ENV.K6_STAGE_3_TARGET || '20');
